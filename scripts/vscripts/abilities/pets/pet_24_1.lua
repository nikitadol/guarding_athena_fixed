---@class pet_24_1: eom_ability
pet_24_1 = eom_ability({
	funcCondition = function(hAbility)
		return hAbility:GetAutoCastState()
	end
}, nil, ability_base_ai)
function pet_24_1:GetRadius()
...
----------------------------------------Modifier----------------------------------------
---@class modifier_pet_24_1 : eom_modifier
modifier_pet_24_1 = eom_modifier({
	Name = "modifier_pet_24_1",
	IsHidden = false,
	IsDebuff = false,
	IsPurgable = false,
...
----------------------------------------Modifier----------------------------------------
---@class modifier_pet_24_1_slow : eom_modifier
modifier_pet_24_1_slow = eom_modifier({
	Name = "modifier_pet_24_1_slow",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = true,
	IsPurgeException = false,
