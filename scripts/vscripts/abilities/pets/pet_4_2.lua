---@class pet_4_2: eom_ability
pet_4_2 = eom_ability({})
function pet_4_2:GetIntrinsicModifierName()
	return "modifier_pet_4_2"
end
----------------------------------------Modifier----------------------------------------
---@class modifier_pet_4_2 : eom_modifier
modifier_pet_4_2 = eom_modifier({
	Name = "modifier_pet_4_2",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
...
----------------------------------------Modifier----------------------------------------
---@class modifier_pet_4_2_debuff : eom_modifier
modifier_pet_4_2_debuff = eom_modifier({
	Name = "modifier_pet_4_2_debuff",
	IsHidden = true,
	IsDebuff = true,
	IsPurgable = false,
	IsPurgeException = false,
...
function modifier_pet_4_2_debuff:OnCreated(params)
	if IsServer() then
		self:GetParent():AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_pet_4_2_freeze", { duration = self:GetAbility():GetDuration() * self:GetParent():GetStatusResistanceFactor() })
	end
end
----------------------------------------Modifier----------------------------------------
---@class modifier_pet_4_2_freeze : eom_modifier
modifier_pet_4_2_freeze = eom_modifier({
	Name = "modifier_pet_4_2_freeze",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = false,
