---@class nevermore_4 : eom_ability
nevermore_4 = eom_ability({})
...
----------------------------------------Modifier----------------------------------------
---@class modifier_nevermore_4_passive : eom_modifier
modifier_nevermore_4_passive = eom_modifier({
	Name = "modifier_nevermore_4_passive",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
...
function modifier_nevermore_4_passive:GetAbilitySpecialValue()
	self.max_charges = self:GetAbilitySpecialValueFor("max_charges")
end
function modifier_nevermore_4_passive:EDeclareFunctions()
	return {
...
----------------------------------------Modifier----------------------------------------
---@class modifier_nevermore_4 : eom_modifier
modifier_nevermore_4 = eom_modifier({
	Name = "modifier_nevermore_4",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = true,
	IsPurgeException = false,
...
function modifier_nevermore_4:ECheckState()
	return {
		[EOM_MODIFIER_STATE_FEARED] = true,
	}
end
----------------------------------------Modifier----------------------------------------
---@class modifier_nevermore_4_aura : eom_modifier
modifier_nevermore_4_aura = eom_modifier({
	Name = "modifier_nevermore_4_aura",
	IsHidden = false,
	IsDebuff = false,
	IsPurgable = false,
	IsPurgeException = false,
...
function modifier_nevermore_4_aura:GetAuraDuration()
	return FrameTime()
end
...
----------------------------------------Modifier----------------------------------------
---@class modifier_nevermore_4_debuff : eom_modifier
modifier_nevermore_4_debuff = eom_modifier({
	Name = "modifier_nevermore_4_debuff",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = false,
	IsPurgeException = false,
...
function modifier_nevermore_4_debuff:GetAbilitySpecialValue()
