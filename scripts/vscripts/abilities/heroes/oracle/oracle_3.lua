---@class oracle_3 : eom_ability
oracle_3 = eom_ability({})
-- 处理2技能的减冷却效果
...
----------------------------------------Modifier----------------------------------------
---@class modifier_oracle_3 : eom_modifier
modifier_oracle_3 = eom_modifier({
	Name = "modifier_oracle_3",
	IsHidden = false,
	IsDebuff = false,
	IsPurgable = true,
...
function modifier_oracle_3:GetAbilitySpecialValue()
...
----------------------------------------Modifier----------------------------------------
---@class modifier_oracle_3_root : eom_modifier
modifier_oracle_3_root = eom_modifier({
	Name = "modifier_oracle_3_root",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = true,
	IsPurgeException = false,
