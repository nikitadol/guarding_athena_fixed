---@class rubick_2 : eom_ability
rubick_2 = eom_ability({})
...
----------------------------------------Modifier----------------------------------------
---@class modifier_rubick_2_root : eom_modifier
modifier_rubick_2_root = eom_modifier({
	Name = "modifier_rubick_2_root",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
...
----------------------------------------Modifier----------------------------------------
---@class modifier_rubick_2_shield : eom_modifier
modifier_rubick_2_shield = eom_modifier({
	Name = "modifier_rubick_2_shield",
	IsHidden = false,
	IsDebuff = false,
	IsPurgable = true,
	IsPurgeException = false,
...
function modifier_rubick_2_shield:GetAbilitySpecialValue()
...
function modifier_rubick_2_shield:OnRefresh(params)
	...
	self.cooldown_reduction = self:GetAbilitySpecialValueFor("cooldown_reduction")
	if IsServer() then
		self.flShieldHealth = self.flShieldHealth + self.shield_factor
	end
end
function modifier_rubick_2_shield:EDeclareFunctions()
	return {
		EOM_MODIFIER_PROPERTY_IGNORE_DAMAGE,
		EOM_MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE
	}
end
function modifier_rubick_2_shield:EOM_GetModifierIgnoreDamage(params)
	if IsServer() then
...
function modifier_rubick_2_shield:EOM_GetModifierPercentageCooldown()
