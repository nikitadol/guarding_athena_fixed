---@class monkey_king_1 : eom_ability
monkey_king_1 = eom_ability({})
function monkey_king_1:OnSpellStart()
	...
	hCaster:Dash(vDirection, flDistance, 150, 0.3, nil, function()
		...
		for _, hUnit in ipairs(tTargets) do
			hUnit:KnockBack((hUnit:GetAbsOrigin() - hCaster:GetAbsOrigin()):Normalized(), 1, 150, 1)
