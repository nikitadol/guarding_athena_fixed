---@class void_spirit_4 : eom_ability
void_spirit_4 = eom_ability({})
...
----------------------------------------Modifier----------------------------------------
---@class modifier_void_spirit_4_phase : eom_modifier
modifier_void_spirit_4_phase = eom_modifier({
	Name = "modifier_void_spirit_4_phase",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
...
function modifier_void_spirit_4_phase:GetAbilitySpecialValue()
	...
	if IsServer() then
		if IsServer() then
			...
			for k, hTarget in pairs(tTargets) do
				hParent:DealDamage(hTarget, self:GetAbility(), self.damage)
...
function modifier_void_spirit_4_phase:ECheckState()
	return {
...
----------------------------------------Modifier----------------------------------------
---@class modifier_void_spirit_4_debuff : eom_modifier
modifier_void_spirit_4_debuff = eom_modifier({
	Name = "modifier_void_spirit_4_debuff",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
	IsPurgeException = false,
...
function modifier_void_spirit_4_debuff:GetAbilitySpecialValue()
...
function modifier_void_spirit_4_debuff:ECheckState()
	return {
		[EOM_MODIFIER_STATE_NO_HEALTH_BAR] = true,
	}
end