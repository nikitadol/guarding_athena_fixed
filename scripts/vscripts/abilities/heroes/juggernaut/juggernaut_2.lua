---@class juggernaut_2 : eom_ability
juggernaut_2 = eom_ability({})
function juggernaut_2:OnSpellStart()
	local hCaster = self:GetCaster()
	local images_count = self:GetSpecialValueFor("images_count")
	local output_damage = self:GetSpecialValueFor("output_damage") - 100
	local input_damage = self:GetSpecialValueFor("input_damage") - 100
	...
	local illusions = hCaster:CreateIllusions(hCaster, { duration = duration, outgoing_damage = output_damage, incoming_damage = input_damage }, images_count, 100, true, true)
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_2 : eom_modifier
modifier_juggernaut_2 = eom_modifier({
	Name = "modifier_juggernaut_2",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
