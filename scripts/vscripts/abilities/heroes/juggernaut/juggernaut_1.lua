---@class juggernaut_1 : eom_ability
juggernaut_1 = eom_ability({})
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_1_buff : eom_modifier
modifier_juggernaut_1_buff = eom_modifier({
	Name = "modifier_juggernaut_1_buff",
	IsHidden = false,
	IsDebuff = false,
	IsPurgable = false,
...
function modifier_juggernaut_1_buff:GetAbilitySpecialValue()
...
function modifier_juggernaut_1_buff:OnIntervalThink()
	if IsServer() then
		...
		local flDamage = self.damage * self.blade_fury_damage_tick
