---@class juggernaut_2_juggernaut_01 : eom_ability
juggernaut_2_juggernaut_01 = eom_ability({})
...
function juggernaut_2_juggernaut_01:CreateMaskGhost(vPosition)
	...
	if hCaster:HasScepter() then
		local hModifier = hCaster:FindModifierByName("modifier_scepter")
...
function juggernaut_2_juggernaut_01:OnUpgrade()
	local hCaster = self:GetCaster()
	hCaster:FindAbilityByName("juggernaut_2_juggernaut_01_1"):SetLevel(self:GetLevel())
end
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_2_juggernaut_01_thinker : eom_modifier
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_2_juggernaut_01_illusion : eom_modifier
...
function modifier_juggernaut_2_juggernaut_01_illusion:EDeclareFunctions()
	return {
		EOM_MODIFIER_PROPERTY_STATS_ALL_BASE_PERCENTAGE = self.property_pct - 100
	}
end
function modifier_juggernaut_2_juggernaut_01_illusion:ECheckState()
	return {
	-- [EOM_MODIFIER_STATE_NO_HEALTH_BAR] = true
	}
end
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_2_juggernaut_01_buff : eom_modifier
...
function modifier_juggernaut_2_juggernaut_01_buff:EDeclareFunctions()
	return {
		EOM_MODIFIER_PROPERTY_STATS_ALL_BASE_PERCENTAGE = self.property_pct,
	}
end
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_2_juggernaut_01_ghost : eom_modifier
...
function modifier_juggernaut_2_juggernaut_01_ghost:ECheckState()
	return {
		[EOM_MODIFIER_STATE_NO_HEALTH_BAR] = true,
	}
end