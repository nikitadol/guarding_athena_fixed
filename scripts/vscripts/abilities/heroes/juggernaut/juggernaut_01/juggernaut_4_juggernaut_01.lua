---@class juggernaut_4_juggernaut_01 : eom_ability
juggernaut_4_juggernaut_01 = eom_ability({})
...
function juggernaut_4_juggernaut_01:OnSpellStart()
	...
	hCaster:KnockBack(hCaster:GetForwardVector(), (hTarget:GetAbsOrigin() - hCaster:GetAbsOrigin()):Length2D(), 4000, 1, nil, nil, function()
		-- 触发天赋
...
function juggernaut_4_juggernaut_01:OnProjectileHit(hTarget, vLocation)
	---@type CDOTA_BaseNPC
	local hCaster = self:GetCaster()
	local flDamage = self:GetSpecialValueFor("wave_damage")
	if hTarget then
		hCaster:DealDamage(hTarget, self, flDamage)
	end
end
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_4_juggernaut_01 : eom_modifier
...
function modifier_juggernaut_4_juggernaut_01:ECheckState()
	return {
		[EOM_MODIFIER_STATE_NO_HEALTH_BAR] = true,
	}
end
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_4_juggernaut_01_debuff : eom_modifier
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_4_juggernaut_01_thinker : eom_modifier
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_4_juggernaut_01_illusion : eom_modifier
...
function modifier_juggernaut_4_juggernaut_01_illusion:ECheckState()
	return {
		[EOM_MODIFIER_STATE_NO_HEALTH_BAR] = true,
	}
end
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_4_juggernaut_01_inv : eom_modifier
