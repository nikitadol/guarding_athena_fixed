---@class juggernaut_0_juggernaut_01 : eom_ability
juggernaut_0_juggernaut_01 = eom_ability({})
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_0_juggernaut_01 : eom_modifier
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_0_juggernaut_01_mark : eom_modifier
	...
	if IsServer() then
		...
		if IsValid(hCaster) then
			if hCaster:GetScepterLevel() >= 1 then
				...
				---@type CDOTABaseAbility
				local hAbility = self:GetAbility()
				local flDamage = self.scepter_mark_damage * self:GetStackCount()
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_0_juggernaut_01_buff : eom_modifier
