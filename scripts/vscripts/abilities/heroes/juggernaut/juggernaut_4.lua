---@class juggernaut_4 : eom_ability
juggernaut_4 = eom_ability({})
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_4 : eom_modifier
modifier_juggernaut_4 = eom_modifier({
	Name = "modifier_juggernaut_4",
	IsHidden = false,
	IsDebuff = false,
	IsPurgable = false,
...
function modifier_juggernaut_4:GetAbilitySpecialValue()
...
function modifier_juggernaut_4:EDeclareFunctions()
	return {
		EOM_MODIFIER_PROPERTY_ATTACK_DAMAGE_BONUS = self.damage
	}
end
...
----------------------------------------Modifier----------------------------------------
---@class modifier_juggernaut_4_buff : eom_modifier
modifier_juggernaut_4_buff = eom_modifier({
	Name = "modifier_juggernaut_4_buff",
	IsHidden = false,
	IsDebuff = false,
	IsPurgable = false,
	IsPurgeException = false,
