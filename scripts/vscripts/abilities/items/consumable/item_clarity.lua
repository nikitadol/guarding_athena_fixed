...
function item_clarity:OnSpellStart()
	...
	if hCaster:HasModifier("modifier_courier") then
...
function modifier_item_clarity:EDeclareFunctions()
	return {
		EOM_MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = self.mana_per_tick or 0
	}
end
---------------------------------------------------------------------
