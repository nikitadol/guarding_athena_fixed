...
function item_fazhang:OnSpellStart()
	...
	hCaster:EmitSound("Hero_Lion.FoD.Cast.TI8_layer")
	EmitSoundOnLocationWithCaster(vPosition, "Hero_Lion.FoD.Target.TI8_layer", hCaster)
end
...
function modifier_item_fazhang:GetAbilitySpecialValue()
	...
	self.ignore_armor_pct				= self:GetAbilitySpecialValueFor("ignore_armor_pct") or 0
end
...
function modifier_item_fazhang:EOM_GetModifierIgnoreArmorPercentage(params)
	if params and params.damage_type and params.damage_type == DAMAGE_TYPE_MAGICAL then
