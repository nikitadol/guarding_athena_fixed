---@class elite_7_1: eom_ability
elite_7_1 = eom_ability({}, nil, ability_base_ai)
...
----------------------------------------Modifier----------------------------------------
---@class modifier_elite_7_1 : eom_modifier
modifier_elite_7_1 = eom_modifier({
	Name = "modifier_elite_7_1",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = true,
