---@class poseidon_1: eom_ability
poseidon_1 = eom_ability({}, nil, ability_base_ai)
function poseidon_1:GetRadius()
...
----------------------------------------Modifier----------------------------------------
---@class modifier_poseidon_1 : eom_modifier
modifier_poseidon_1 = eom_modifier({
	Name = "modifier_poseidon_1",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
...
----------------------------------------Modifier----------------------------------------
---@class modifier_poseidon_1_thinker : eom_modifier
modifier_poseidon_1_thinker = eom_modifier({
	Name = "modifier_poseidon_1_thinker",
	IsHidden = true,
	IsDebuff = false,
	IsPurgable = false,
	IsPurgeException = false,
...
----------------------------------------Modifier----------------------------------------
---@class modifier_poseidon_1_motion : eom_modifier
modifier_poseidon_1_motion = eom_modifier({
	Name = "modifier_poseidon_1_motion",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = false,
	IsPurgeException = false,
...
function modifier_poseidon_1_motion:OnCreated(params)
	if IsServer() then
		self.torrent_damage = self:GetAbility():GetAbilityDamage()
...
----------------------------------------Modifier----------------------------------------
---@class modifier_poseidon_1_debuff : eom_modifier
modifier_poseidon_1_debuff = eom_modifier({
	Name = "modifier_poseidon_1_debuff",
	IsHidden = false,
	IsDebuff = true,
	IsPurgable = false,
	IsPurgeException = false,
